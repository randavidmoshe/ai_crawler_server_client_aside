...
def page_has_form_fields(driver, ai_classifier=None) -> bool:
    """Check if page has form fields AND submission button"""
    try:
        ...
        for button in buttons:
            ...
            if ai_classifier:
                ...
                if ai_classifier(text):
                    print(f"[Form Check]     ✅ AI says YES - this is a submission button!")
                    return True
                else:
        ...
        print(f"[Form Check] Checked {checked_count} buttons, none were submission buttons")
        return False
